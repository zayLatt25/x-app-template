...
export default function Profile() {
  ...
  return (
    <div className="absolute inset-0 h-full max-w-sm">
      <div className="bg-white px-4 py-10 h-full flex flex-col">
        <div className="mb-auto space-y-4">
          <div className="flex place-items-center space-x-4">
            <div className="w-10 h-10 bg-[#506c4c] rounded-full"></div>
        ...
        <button className="bg-yellow-500 w-full rounded-lg py-2 text-extrabold">
          Logout
        </button>
      </div>
    </div>
